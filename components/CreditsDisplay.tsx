...
const CreditsDisplay: React.FC = () => {
  ...
  return (
    <div className="relative">
      <div 
        className="flex items-center gap-1.5 sm:gap-2 py-1 px-1.5 sm:px-2 rounded-md bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-xs font-medium cursor-help transition-colors"
      ...
      >
        ...
        <span className="whitespace-nowrap text-gray-700 dark:text-gray-300 transition-colors text-[10px] sm:text-xs">
          {credits.current}/{credits.max} Credits
        </span>
        <div className="w-16 sm:w-24 h-1.5 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden transition-colors">
          <div 
